...
class PeerDiscovery {
    ...
    static async new({ networkOrHost, defaultPort = 4003, }) {
        ...
        try {
            if (is_url_superb_1.default(networkOrHost)) {
                ...
                const body = await ky_universal_1.default.get(`https://raw.githubusercontent.com/xphchain/peers/master/${networkOrHost}.json`).json();
